...
const ::google::protobuf::EnumDescriptor* Phone_PHONE_TYPE_descriptor_ = NULL;
...
void protobuf_AssignDesc_person_2eproto() {
  ...
  Person_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(Person));
  Phone_descriptor_ = file->message_type(1);
  static const int Phone_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Phone, num_),
  ...
  Phone_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(Phone));
  Phone_PHONE_TYPE_descriptor_ = Phone_descriptor_->enum_type(0);
}
...
void protobuf_AddDesc_person_2eproto() {
  ...
  ::google::protobuf::internal::ExtensionSet::RegisterMessageExtension(
    &::Person::default_instance(),
    10, 11, true, false,
    &::Phone::default_instance());
...
const ::google::protobuf::EnumDescriptor* Phone_PHONE_TYPE_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Phone_PHONE_TYPE_descriptor_;
}
...
#ifndef _MSC_VER
const Phone_PHONE_TYPE Phone::MOBILE;
const Phone_PHONE_TYPE Phone::HOME;
const Phone_PHONE_TYPE Phone::PHONE_TYPE_MIN;
const Phone_PHONE_TYPE Phone::PHONE_TYPE_MAX;
const int Phone::PHONE_TYPE_ARRAYSIZE;
#endif  // _MSC_VER
#ifndef _MSC_VER
const int Phone::kNumFieldNumber;
const int Phone::kTypeFieldNumber;
#endif  // !_MSC_VER

#ifndef _MSC_VER
const int Phone::kPhonesFieldNumber;
#endif
::google::protobuf::internal::ExtensionIdentifier< ::Person,
    ::google::protobuf::internal::RepeatedMessageTypeTraits< ::Phone >, 11, false >
  Phone::phones(kPhonesFieldNumber, ::Phone::default_instance());
Phone::Phone()
  : ::google::protobuf::Message() {
  SharedCtor();
        ...
        if (tag == 16) {
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::Phone_PHONE_TYPE_IsValid(value)) {
            set_type(static_cast< ::Phone_PHONE_TYPE >(value));
          } else {
